...
for i in range(50):
    ...
    f = open('/net/ht140/payam-hadar/DL/saved_weight_layer0_2D', 'wb')
    f1 = open('/net/ht140/payam-hadar/DL/saved_weight_layer1_2D', 'wb')
    f2 = open('/net/ht140/payam-hadar/DL/saved_weight_layer15_2D', 'wb')
    f3 = open('/net/ht140/payam-hadar/DL/saved_weight_layer175_2D', 'wb')
    f35 = open('/net/ht140/payam-hadar/DL/saved_weight_layer2_2D', 'wb')
    f4 = open('/net/ht140/payam-hadar/DL/saved_weight_layer3_2D', 'wb')
    pickle.dump(w, f)
    pickle.dump(w2, f1)
    pickle.dump(w3, f2)
    pickle.dump(w35, f3)
